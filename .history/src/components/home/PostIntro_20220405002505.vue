    ...
    <div class="message">
      <div class="postTitle">
        <span v-if="postVo.post.official===1" 
          style="background-color: #ffa000;font-size: 16px;border-radius: 5px;margin-right: 6px;font-weight:bold;padding: 2px;">&#xeb63;</span>
        <span v-if="postVo.post.top===1" 
          style="background-color: #40ffc9;font-size: 16px;border-radius: 5px;margin-right: 6px;font-weight:bold;padding: 2px;">&#xe672;</span>
