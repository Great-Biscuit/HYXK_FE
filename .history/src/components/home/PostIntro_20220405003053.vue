    ...
    <div class="message">
      <div class="postTitle">
        <span v-if="postVo.post.official===1" class="iconfont" 
          style="background-color: #ffa000;font-size: 16px;border-radius: 5px;font-weight:bold;padding: 2px;">&#xe7e8;</span>
        <span v-if="postVo.post.top===1" class="iconfont" 
          style="background-color: #40ffc9;font-size: 16px;border-radius: 5px;font-weight:bold;padding: 2px;">&#xe672;</span>
