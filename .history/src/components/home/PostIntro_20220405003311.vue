    ...
    <div class="message">
      <div class="postTitle">
        <span v-if="postVo.post.official===1" class="iconfont" 
          style="background-color: #ffa000;border-radius: 5px;font-weight:bold;font-size:24px;">&#xe7e8;</span>
        <span v-if="postVo.post.top===1" class="iconfont" 
          style="background-color: #40ffc9;border-radius: 5px;font-weight:bold;font-size:24px;">&#xe672;</span>
