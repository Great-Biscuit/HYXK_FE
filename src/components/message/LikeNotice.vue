<template>
  <div class="wrapper">
    ...
    <div class="content__wrapper" v-loading="loading">
      ...
      <div v-for="item in likeNoticeList" :key="item.id" class="notice__item" @click="handleNoticeClick(item.postId)">
        ...
        <div class="notice__wrapper">
          <div class="notice__middle">
            <div>
              ...
              <span class="notice__type" v-if="!item.targetEntity.comment">赞了你的笔记</span>
